          ...
          >
            ...
            <div
              className={cn(
                ...
                index % 2 === 0 ? "md:pr-6 text-center md:text-right" : "md:pl-6 text-center md:text-left"
              )}
            >
              <Card>
                <CardHeader>
            ...
            {/* Индикатор таймлайна (скрыт на мобильных устройствах) */}
            <div className="absolute left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 hidden md:block">
              <div
                className={cn(
                  ...
                  index === 0 ? "border-blue-500 bg-blue-100 text-blue-500" : "border-gray-300 bg-white text-gray-500"
                )}
              >
                {index + 1}
              </div>
